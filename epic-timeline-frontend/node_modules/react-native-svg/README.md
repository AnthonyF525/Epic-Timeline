...
> [ICON] The [Expo client app](https://expo.io/tools) comes with the native code installed!
...
[ICON] See the [**Expo docs**](https://docs.expo.io/versions/latest/sdk/svg/) for more info or jump ahead to [Usage](#usage).
