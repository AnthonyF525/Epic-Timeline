...
function warnWithDeprecationSchedule() {
  ...
  console.warn(`
${styleText('yellow', '⚠•')} The \`init\` command is deprecated.
...
function warnWithDeprecated() {
  ...
  console.warn(`
ERROR• The \`init\` command is deprecated.
...
function warnWithExplicitDependency(version /*: string */ = '*') {
  console.warn(`
${styleText('yellow', '⚠')}• ${styleText(['dim'], 'react-native')} depends on ${styleText('dim', '@react-native-community/cli')} for cli commands. To fix update your ${styleText(['dim'], 'package.json')} to include:
