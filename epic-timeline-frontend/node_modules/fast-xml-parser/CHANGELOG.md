...
**[ICON][ICON] 4.0.0-beta.0 / 2021-11-16**
...
3.21.0 / 2021-10-25
  ...
  - [ICON][ICON] feat: Better error location for unclosed tags. (by *@Gei0r*)
  ...
  - [ICON][ICON] feat: Column in error response when validating XML
```js
{
  "code": "InvalidAttr",
